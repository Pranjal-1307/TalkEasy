...
class _MyAppState extends State<MyApp> {
  late RtcEngine agoraEngine;
  final String appId = "6900741fa0f04513af9befbd65522483"; // 🔥 Your Agora App ID
  final String token = "007eJxTYGBUYWL0cFiQX74uTtvuV5bumwe1V58rp/w8xba5+6i/53UFBjNLAwNzE8O0RIM0AxNTQ+PENMuk1LSkFDNTUyMjEwvjjRGf0hsCGRnWuwoyMTIwMrAAMYjPBCaZwSQLmORgKEnMyU5NLK5kYAAAnRUimA=="; // 🔥 Replace with a valid token
  final String channelName = "TalkEasy";
  bool isMicMuted = false;
  bool isSpeakerOn = true;
